...
def scrape_sag_awards(url, start_year=2004):
    ...
    # Localiza o elemento HTML específico
    specific_container = soup.find('td', {'class': 'navbox-list', 'style': 'width:100%;padding:0'})
    ...
    for item in items:
        ...
        if match:
            ...
            if year >= start_year:  # Filtrar apenas anos a partir de 2004
                ...
                awards.append({
                    "Ano": year,
                    "Premiação": "Screen Actors Guild Award for Outstanding Performance by a Cast",
                    "Filme": film
                })
    ...
    folder = "FILE"
    file_name = "SAG_Awards_From_2004.csv"
...
# Executar o scraping
scrape_sag_awards(url, start_year=2004)
